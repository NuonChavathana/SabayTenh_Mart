            ...
            <div className="flex items-start justify-between flex-wrap gap-3">
              ...
              <Sheet>
                ...
                <SheetContent side="left">
                  ...
                  <div className="mt-4 overflow-y-auto"><FiltersContent /></div>
                </SheetContent>
              </Sheet>
            </div>
            ...
            {(searchQuery || hasFilters || featuredOnly) && (
              <div className="flex flex-wrap gap-2 mt-3">
                ...
                {minPrice && (
                  <Badge variant="secondary" className="gap-1.5 pr-1.5 text-xs">
                    ${minPrice}+ 
                    <button onClick={() => setMinPrice("")} className="hover:text-destructive ml-0.5"><X className="h-3 w-3" /></button>
                  </Badge>
                )}
                {maxPrice && (
                  <Badge variant="secondary" className="gap-1.5 pr-1.5 text-xs">
                    {t("Under", "ក្រោម")} ${maxPrice}
                    <button onClick={() => setMaxPrice("")} className="hover:text-destructive ml-0.5"><X className="h-3 w-3" /></button>
                  </Badge>
                )}
                {hasFilters && (
                  <button
