    ...
    <div className="bg-white dark:bg-card border rounded-xl overflow-hidden hover:shadow-lg transition-all duration-200 group">
      <Link href={`/products/${product.id}`} className="relative block overflow-hidden bg-muted">
        <div className="aspect-square overflow-hidden">
          <img
            src={product.image || "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500"}
            alt={product.name}
...
export default function CategoryPage() {
  ...
  const clearFilters = () => {
    ...
    setMinPrice(""); setMaxPrice(""); setMinRating(undefined);
          ...
          <div className="flex-1 min-w-0">
            {!categories ? (
              ...
              <div className="text-center py-20">
                <div className="text-6xl mb-4">{CATEGORY_ICONS[slug] ?? "🛍️"}</div>
