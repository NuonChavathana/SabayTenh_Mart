        ...
        <div className="container mx-auto px-4 py-5 flex flex-col sm:flex-row items-center gap-4 justify-between">
          <div>
            ...
            <p className="text-white/80 text-sm">
              {t("Subscribe for offers, new arrivals & flash sales", "ជាវសម្រាប់ការផ្ដល់ជូន ទំនិញថ្មី និងការបញ្ចុះតម្លៃ")}
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5">
              {t(
                "Cambodia's mini mart for groceries, electronics, fashion & more — delivered fast nationwide.",
                "mini mart របស់កម្ពុជាសម្រាប់គ្រឿងទំនិញ អេឡិចត្រូនិច ម៉ូត និងច្រើនទៀត — ដឹកជញ្ជូនលឿនទូទាំងប្រទេស។"
              )}
            </p>
